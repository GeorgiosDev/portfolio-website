...
<div name="About" className="w-full min-h-screen bg-gradient-to-b from-gray-800 to-black text-white pt-16">
  <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center items-center w-full min-h-full">
    <div className="pb-8">
      <p className="text-4xl font-bold inline  items-center">About Me</p>
    </div>
    <p className="text-xl mt-8 md:mt-10 text-justify ">
